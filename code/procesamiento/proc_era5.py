...
gdf_era5 = gpd.read_file(f'data/procesado/era5/era5_{incendio}_puntos.geojson') 
...
### plot -------------- 
gdf = gdf_era5[gdf_era5['date_time'] == '2017-02-05 19:00:00']
...
ax.set_title('Vectores de viento ERA5 (10 m)')
...
## save data
gdf_era5.to_file(f'data/procesado/era5/era5_variables_{incendio}.geojson')
